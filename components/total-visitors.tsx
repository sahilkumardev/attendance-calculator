    ...
    <div className="flex items-center gap-6 text-sm text-muted-foreground">
      <div className="flex items-center gap-2 group">
        ...
        <span className="font-medium">
          <span className="text-foreground tabular-nums">{data?.total.toLocaleString() || 0}</span> Total Visits
        </span>
      </div>
      <div className="flex items-center gap-2 group">
        <Users className="h-4 w-4 transition-transform group-hover:scale-110" />
        <span className="font-medium">
          <span className="text-foreground tabular-nums">{data?.unique.toLocaleString() || 0}</span> Unique Visitors
        </span>
      </div>
